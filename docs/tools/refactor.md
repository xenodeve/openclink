...
"Using openclink's refactor decompose the all_in_one_sync_code.swift into maintainable extensions"
```
...
"First, think about how the authentication module works, find related classes and find
 any code smells, then using openclink's refactor ask flash to confirm your findings but ask 
